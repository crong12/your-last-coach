...
- Evidence: [Chart rendering approach — research note](../research/chart-rendering-approach.md)
...
Candidates evaluated (sizes and rejection reasons in the research note): hand-rolled SVG, full D3, D3 math modules + React SVG, visx, Recharts, Observable Plot, Chart.js, uPlot.
...
- The team owns axis/annotation rendering code (the trade for total fidelity); tick *placement* quality still comes from d3-scale.
